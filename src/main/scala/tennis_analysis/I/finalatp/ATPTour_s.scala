...
case class PlayerT(name: String, country: String)
case class MatchT(matchType: String, points: Int, head2HeadCount: Int)
...
object ATPTour {
  ...
  def createGraph(sc: SparkContext): Graph[PlayerT, MatchT] = {
    val players: RDD[(Long, PlayerT)] = sc.parallelize(Array(
      (1L, PlayerT("Novak Djokovic", "SRB")),
      (3L, PlayerT("Roger Federer", "SUI")),
      (5L, PlayerT("Tomas Berdych", "CZE")),
      (7L, PlayerT("Kei Nishikori", "JPN")),
      (11L, PlayerT("Andy Murray", "GBR")),
      (15L, PlayerT("Stan Wawrinka", "SUI")),
      (17L, PlayerT("Rafael Nadal", "ESP")),
      (19L, PlayerT("David Ferrer", "ESP"))
    ))

    val matches: RDD[Edge[MatchT]] = sc.parallelize(Array(
      Edge(1L, 5L, MatchT("G1", 1, 1)),
      Edge(1L, 7L, MatchT("G1", 1, 1)),
      Edge(3L, 1L, MatchT("G1", 1, 1)),
      Edge(3L, 5L, MatchT("G1", 1, 1)),
      Edge(3L, 7L, MatchT("G1", 1, 1)),
      Edge(7L, 5L, MatchT("G1", 1, 1)),
      Edge(11L, 19L, MatchT("G2", 1, 1)),
      Edge(15L, 11L, MatchT("G2", 1, 1)),
      Edge(15L, 19L, MatchT("G2", 1, 1)),
      Edge(17L, 11L, MatchT("G2", 1, 1)),
      Edge(17L, 15L, MatchT("G2", 1, 1)),
      Edge(17L, 19L, MatchT("G2", 1, 1)),
      Edge(3L, 15L, MatchT("S", 5, 1)),
      Edge(1L, 17L, MatchT("S", 5, 1)),
      Edge(1L, 3L, MatchT("F", 11, 1))
    ))
  ...
  def displayGraphInfo(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  // Génération d'une visualisation différente (style circulaire)
  def generateGraphVisualization(graph: Graph[PlayerT, MatchT]): Unit = {

    val vertices = graph.vertices.collect().toMap
    val edges    = graph.edges.collect()

    val dotFile = "assets/graphe_tournoi_alt.dot"
    val pngFile = "assets/graphe_tournoi_alt.png"
    ...
    // Matches (edges)
    edges.foreach { edge =>
      val label = edge.attr.matchType

      val (color, style) = edge.attr.matchType match {
        case "F" => ("#E91E63", "bold")      // Final - Pink, bold
        case "S" => ("#9C27B0", "dashed")    // Semi-final - Purple, dashed
        case _   => ("#4CAF50", "solid")     // Other rounds - Green, solid
      }
  ...
  def runAllAnalysis(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question1(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question2(graph: Graph[PlayerT, MatchT]): Unit = {
    println("\n2. Liste des matchs:")
  ...
  def question3(graph: Graph[PlayerT, MatchT]): Unit = {
    println("\n3. Vainqueurs du  G1 :")
  ...
  def question4(graph: Graph[PlayerT, MatchT]): Unit = {
    println("\n4. Vainqueurs du G2 :")
  ...
  def question5(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question6(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question7(graph: Graph[PlayerT, MatchT]): Seq[(String, Int)] = {
  ...
  def question8(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question8_(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question9(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question10(graph: Graph[PlayerT, MatchT]): Unit = {
    ...
    def printP(title: String, filterFunc: ((Long, PlayerT)) => Boolean): Unit = {
      println(title)
  ...
  def question11(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question12(graph: Graph[PlayerT, MatchT]): Unit = {
  ...
  def question13(graph: Graph[PlayerT, MatchT]): Unit = {
